...
const userSchema = new mongoose.Schema({
  ...
  name: {
    type: String,
    minlength: [2, 'Имя должно быть не короче 2-х символов.'],
    maxlength: [30, 'Имя не должно быть длинее 30-и символов.'],
  ...
  avatar: {
    ...
    validate: {
      validator(avatar) {
        return /https?:\/\/(.+?)\/(([a-zA-Z0-9_ \-%.]*)\.(jpg|png|jpeg|gif|webp))/.test(avatar);
      },
